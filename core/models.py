...
class Master(models.Model):
    ...
    photo = models.ImageField(
        upload_to="masters/", blank=True, verbose_name="Фотография"
    )
...
class Review(models.Model):
    ...
    def __str__(self):
        return f"{self.client_name or 'Аноним'} — {self.master.name}"
...
class Order(models.Model):
    ...
    master = models.ForeignKey(
        Master, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Мастер"
    )
    services = models.ManyToManyField(
