# Generated by Django 4.2.15 on 2025-09-16 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_approved', 'Не подтверждён'), ('approved', 'Подтверждён'), ('completed', 'Завершён')], default='not_approved', max_length=50, verbose_name='Статус')),
